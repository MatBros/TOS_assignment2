...
public class ImplementationTakeAwayBill implements TakeAwayBill{
	 public double getOrderPrice(List<MenuItem> itemsOrdered) throws RestaurantBillException{
		 ...
		 double Tot=0.0, solidiTot=0.0, bevTot=0.0, paninoMenoCaro=10000.0;
	        ...
	        //3) controllo che l'ordinazione sia di <=30 items (fatto per primo per risparmiare)
	        if(itemsOrdered.size()>30) throw new RestaurantBillException();
